...
email(String recipient, DateTime due) async {
  print('in Email func');
  ...
  final message = Message()
    ...
    ..text =
        'Gentle reminder regarding your Health/Motor Policy is falling due for renewal on ${due.day}/${due.month}/${due.year}'; //body of the email
